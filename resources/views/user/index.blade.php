...
<head>
    ...
    <!-- Datetimepicker -->
    <link rel="stylesheet" href="/user/css/bootstrap-datetimepicker.min.css">
    <!-- Flexslider -->
...
<div id="fh5co-container">
    <div id="fh5co-home" class="js-fullheight" data-section="home">
        ...
        <div class="flexslider">
            ...
            <ul class="slides">
                <li style="background-image: url(/user/images/slide_1.jpg);" data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(/user/images/slide_2.jpg);" data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(/user/images/slide_3.jpg);" data-stellar-background-ratio="0.5"></li>
            </ul>
            ...
            <div class="row">
                <div class="fh5co-grid">
                    <div class="fh5co-v-half to-animate-2">
                        <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url('/user/images/res_img_1.jpg')"></div>
                    ...
                    <div class="fh5co-v-half">
                        <div class="fh5co-h-row-2 to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url('/user/images/res_img_2.jpg')"></div>
                        ...
                        <div class="fh5co-h-row-2 fh5co-reversed to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url('/user/images/res_img_8.jpg')"></div>
                    ...
                    <div class="fh5co-v-half">
                        <div class="fh5co-h-row-2 fh5co-reversed to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url('/user/images/res_img_7.jpg')"></div>
                            <div class="fh5co-v-col-2 fh5co-text arrow-right">
                                <h2>Organic Egg</h2>
                        ...
                        <div class="fh5co-h-row-2 to-animate-2">
                            <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url(/user/images/res_img_6.jpg)"></div>
                            <div class="fh5co-v-col-2 fh5co-text arrow-left">
                    ...
                    <div class="fh5co-v-half to-animate-2">
                        <div class="fh5co-v-col-2 fh5co-bg-img" style="background-image: url(/user/images/res_img_3.jpg)"></div>
                        <div class="fh5co-v-col-2 fh5co-text fh5co-special-1 arrow-left">
    ...
    <div id="fh5co-type" style="background-image: url(/user/images/mqnzara1.jpg);" data-stellar-background-ratio="0.5">
        <div class="fh5co-overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-1">Quroni Karim</h3>
                        <p>Quroni Karim kitobi komplekti va diniy kitoblar </p>
                    </div>
                </div>
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-2">Bezaklar</h3>
                        <p>Jannatim Onam bezaklari va to`y bezaklar</p>
                    </div>
                </div>
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-3">Shirinlilar</h3>
                        <p> Turli xil to`rtlar va shokolodlar to`plami </p>
                    </div>
                </div>
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-4">Qo`l soatlari</h3>
                        <p>Turli xil erkaklar va ayollar soatlari </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-5">O`yinchoqlar</h3>
                        <p>Turli xil bolalar yumshoq o`yinchoqlari, o`yinchoq mashinalar va samakatlar</p>
                    </div>
                </div>
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-6">Chashkalar</h3>
                        <p>Rasm va yozuvlar tushirilgan chashkalar</p>
                    </div>
                </div>
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-7">Gullar</h3>
                        <p>Jannatim Onam yozuvi tushirilgan gullar, tabiiy va suniy buket gullar</p>
                    </div>
                </div>
                <div class="col-md-3 to-animate">
                    <div class="fh5co-type">
                        <h3 class="with-icon icon-8">Portretlar</h3>
                        <p>Portret rasmlar va portret soatlar</p>
                    </div>
                </div>
            </div>
        </div>
...
{{--Inoshu haqiqiy}}
{{--    <div class="menyu" id="fh5co-events" style="background: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(/user/images/wood_1.jpg),center,no-repeat;">--}}
{{--        <div class="container">--}}
{{--            <div class="row" style="display: inline-block;">--}}
{{--                @foreach($sovgani_chiqar as $value)--}}

{{--                <div class="col-md-4" style="width: 350px; background-color:#fff; border: 1px solid black;">--}}
{{--                    <div class="card" style="margin-right: 10px;">--}}
{{--                        <img src="{{asset($value->image)}}" class="card-img-top" alt="..." style="width: 300px; margin: 30px 0 -15px 10px;">--}}
{{--                    </div>--}}
{{--                    <div class="card-body" style="text-align: center;">--}}
{{--                        <h3 class="card-title">{{$value->name}}</h3>--}}
{{--                        <p class="card-text" style="font-size: 14px;">{{$value->description}}</p>--}}
{{--                        <p class="card-text" style="color: blue;margin-top: -15px;" >{{'Narxi: '.$value->narx.' so`m'}}</p>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                @endforeach--}}
                            ...
                            @foreach($sovgani_chiqar as $value)
                                ...
                                <li>
                                    <div class="fh5co-food-desc">
                                        <figure>
                                            <img src="{{asset($value->image)}}" class="img-responsive" alt="{{$value->name}}">
                                        </figure>
                                        <div>
                                            <h3>{{$value->name}}</h3>
...
{{--    pasi--}}
   ...
   <div id="fh5co-events" data-section="events" style="background-image: url(/user/images/slide_2.jpg);" data-stellar-background-ratio="0.5">
        <div class="fh5co-overlay"></div>
        <div class="container">
            <div class="row text-center fh5co-heading row-padded">
...
<script src="/user/js/bootstrap-datetimepicker.min.js"></script>
<!-- Waypoints -->
