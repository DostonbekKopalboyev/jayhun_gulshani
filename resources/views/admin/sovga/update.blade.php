        ...
        <form action="{{route('sovga.update',$sovga->id)}}" method="POST" style="width: 30vw;" enctype="multipart/form-data" id="saved">
            ...
            <div class="mb-3" >
                ...
                <div class="md-3">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$sovga['name']}}">
                </div>
                <br>

                <div class="md-3">
                    <label class="form-label">Izoh: </label>
                    <textarea type="text" class="form-control my-6" name="description"  style="height: 100px;" >{{$sovga['description']}}</textarea>
                </div>
                <br>
                <div class="md-3">
                    <label class="form-label">Sovg`ani narxi: </label>
                    <input type="number" class="form-control" name="narx" value="{{$sovga['narx']}}">
                </div>
                <br>
